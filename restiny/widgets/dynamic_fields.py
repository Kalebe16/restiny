...
class DynamicField(Static):
    ...
    class Empty(Message):
        ...
        def __init__(self, field_empty: 'DynamicField') -> None:
            super().__init__()
    ...
    class Filled(Message):
        ...
        def __init__(self, field_filled: 'DynamicField') -> None:
            super().__init__()
            self.field_filled = field_filled
    ...
    def on_input_changed(self, message: Input.Changed) -> None:
        ...
        if self.is_empty:
            self.post_message(message=self.Empty(field_empty=self))
        elif self.is_filled:
            self.post_message(message=self.Filled(field_filled=self))
...
class DynamicFields(Static):
    ...
    async def on_field_is_empty(self, message: DynamicField.Empty) -> None:
        await self.remove_field(field=message.field_empty)
