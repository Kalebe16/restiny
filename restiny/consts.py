...
CUSTOM_THEMES: dict[CustomThemes, dict[Theme | TextAreaTheme]] = {
    ...
    CustomThemes.DESERT: {
        ...
        'text_area': TextAreaTheme(
            name='desert',
            base_style=Style(color='#2A2A2A', bgcolor='#F9F6F0'),
            gutter_style=Style(color='#8E8B84', bgcolor='#EFE9DE'),
            cursor_style=Style(color='#F9F6F0', bgcolor='#2A2A2A'),
            cursor_line_style=Style(bgcolor='#E5DDCF'),
            cursor_line_gutter_style=Style(color='#6B6A66', bgcolor='#E5DDCF'),
            bracket_matching_style=Style(bgcolor='#D7CEBE', bold=True),
            selection_style=Style(bgcolor='#D9E3F3'),
            syntax_styles={
                'string': Style(color='#7A4E00'),
                'string.documentation': Style(color='#7A4E00'),
                'comment': Style(color='#8C8477', italic=True),
                'heading.marker': Style(color='#9B6B00'),
                'keyword': Style(color='#C58A1B', bold=True),
                'operator': Style(color='#2A2A2A'),
                'conditional': Style(color='#C58A1B'),
                'keyword.function': Style(color='#C58A1B'),
                'keyword.return': Style(color='#C58A1B'),
                'keyword.operator': Style(color='#C58A1B'),
                'repeat': Style(color='#C58A1B'),
                'exception': Style(color='#C04B4B'),
                'include': Style(color='#C58A1B'),
                'number': Style(color='#8B6B2E'),
                'float': Style(color='#8B6B2E'),
                'class': Style(color='#6B8E23'),
                'type': Style(color='#6B8E23'),
                'type.class': Style(color='#6B8E23'),
                'type.builtin': Style(color='#9B6B00'),
                'variable.builtin': Style(color='#2A2A2A'),
                'function': Style(color='#C58A1B'),
                'function.call': Style(color='#C58A1B'),
                'method': Style(color='#C58A1B'),
                'method.call': Style(color='#C58A1B'),
                'constructor': Style(color='#6B8E23'),
                'boolean': Style(color='#7DAF9C'),
                'constant.builtin': Style(color='#7DAF9C'),
                'json.null': Style(color='#7DAF9C'),
                'regex.punctuation.bracket': Style(color='#9B6B00'),
                'regex.operator': Style(color='#9B6B00'),
                'html.end_tag_error': Style(color='#C04B4B', underline=True),
                'tag': Style(color='#9B6B00'),
                'yaml.field': Style(color='#9B6B00', bold=True),
                'json.label': Style(color='#9B6B00', bold=True),
                'toml.type': Style(color='#9B6B00'),
                'toml.datetime': Style(color='#8B6B2E'),
                'css.property': Style(color='#8B6B2E'),
                'heading': Style(color='#9B6B00', bold=True),
                'bold': Style(bold=True),
                'italic': Style(italic=True),
                'strikethrough': Style(strike=True),
                'link.label': Style(color='#9B6B00'),
                'link.uri': Style(color='#8B6B2E', underline=True),
                'list.marker': Style(color='#8E8B84'),
                'inline_code': Style(color='#7A4E00'),
                'info_string': Style(color='#7A4E00', bold=True, italic=True),
                'punctuation.bracket': Style(color='#2A2A2A'),
                'punctuation.delimiter': Style(color='#2A2A2A'),
                'punctuation.special': Style(color='#2A2A2A'),
            },
        ),
    },
}
