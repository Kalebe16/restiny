...
### Changed
- More improves system requirements setup

## [1.4.0] - 2026-07-22

### Changed
- Improves system requirements setup
...
### Fixed
- Improves system requirements setup message
- Automatic requirements setup
...
- Automatic system requirements installation
...
- Response download
- Display unicode characters in response JSON body

## [0.14.1] - 2026-03-01

### Fixed

- Update empty state label to match new button names
...
- Attach cookies option

### Fixed

- TextArea copy/cut text to clipboard
- PasswordInput width
